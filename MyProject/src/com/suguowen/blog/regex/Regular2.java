...
public class Regular2 {
	public static void main(String[] args) throws IOException {
		...
		Pattern p = Pattern.compile(">#.*</a>");// regular
		Matcher m = p.matcher("<!DOCTYPE html>\r\n" + "<html>\r\n" + "	<head>\r\n"
				+ "		<meta charset=\"UTF-8\">\r\n" + "		<title></title>\r\n" + "	</head>\r\n"
				+ "	<body>\r\n" + "		\r\n" + "		<table class=\"dataintable\">\r\n" + "<tbody><tr>\r\n"
				+ "<th style=\"width:25%\">\\u989C\\u8272\\u540D</th>\r\n"
				+ "<th style=\"width:25%\">\\u5341\\u516D\\u8FDB\\u5236\\u989C\\u8272\\u503C</th>\r\n"
				+ "<th style=\"width:50%\">\\u989C\\u8272</th>\r\n" + "</tr>\r\n" + "\r\n" + "<tr>\r\n"
				...
				+ "</tbody></table>\r\n" + "		\r\n" + "	</body>\r\n" + "</html>\r\n" + "");// line
		while (m.find()) {
			String colorStyle = m.group().substring(1, 8);
			// System.out.println(m.group().substring(1, 8));
			sb.append(colorStyle + "\r\n");
		}
		File file = new File("colorStyle2.0.txt");
		try {
